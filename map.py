...
class RequesterThread(Thread):
    ...
    def run(self):
        ...
        print(Thread.getName(self), "finish")
...
class Map_prestige():
    def __init__(self):
        ...
        self.colors_grad = ["#33170F", "#3C1C13", "#452216", "#4F271A", "#582D1E", "#623322", "#6C3A25", "#764029",
                            "#80462D", "#8A4D30","#955434", "#9F5B38", "#AA623B", "#B4693F", "#AF7536", "#A58231",
